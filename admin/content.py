...
# ---- events + rsvps admin CRUD (Track B / B13, verbatim; incl _parse_event_payload) ----
...
@content_bp.route("/admin/api/events", methods=["GET"])
@admin_required
...
@content_bp.route("/admin/api/events", methods=["POST"])
@admin_required
...
@content_bp.route("/admin/api/events/<int:event_id>", methods=["PUT"])
@admin_required
...
@content_bp.route("/admin/api/events/<int:event_id>", methods=["DELETE"])
@admin_required
...
@content_bp.route("/admin/api/events/<int:event_id>/rsvps", methods=["GET"])
@admin_required
...
@content_bp.route("/admin/api/event-rsvps/<int:rsvp_id>", methods=["DELETE"])
@admin_required
...
# ---- generated-pages CRUD (Track B, verbatim; AI-authored standalone pages) ----
# Stray content-ish CRUD reusing content_bp (per the refactor plan). Pure
# query_db/execute_db; @admin_required preserved (from core). No shared helpers.


@content_bp.route("/admin/api/generated-pages", methods=["GET"])
@admin_required
...
@content_bp.route("/admin/api/generated-pages/<int:page_id>", methods=["GET"])
@admin_required
...
@content_bp.route("/admin/api/generated-pages/<int:page_id>", methods=["PUT"])
@admin_required
...
@content_bp.route("/admin/api/generated-pages/<int:page_id>", methods=["DELETE"])
@admin_required
