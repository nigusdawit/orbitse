...
to roofing via pull requests (or a fast-forward push).
...
git push roofing main:main          # fast-forward when master hasn't moved
# …or open a PR: ai-concierge-platform → roofing-concierge (preferred for review)
```
